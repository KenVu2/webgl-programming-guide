...
/* 
\author Zachary Wartell
\status This function is tested but not exposed to the application user
...
function main() 
{
  ...
  // Initialize shaders
  if (!initShaders(gl, document.getElementById('shader-v').text, 
  		       document.getElementById('shader-f').text)) {
