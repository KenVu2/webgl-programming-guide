...
/* 
\author Zachary Wartell
\brief procedural generation of texture generated by sinusoidal varying intensity with pixels x coordinate
(in window coordinates).  Point sampling is used at the fragment location. 
...
\brief procedural generation of texture generated by sinusoidal varying
intensity with pixels x coordinate (in window coordinates).  Area sampling is
performing by performing an anaytic integratation of the sin function over the
expanse of the current fragment.  This is also equivalent (?I think?) to performing a convolution 
with a box filter with filter footprint the width of a pixel. 
...
*/
var FSHADER_SOURCE_AREA_SAMPLING =
  '#define pi 3.141592653589793238462643383279 \n' +
  'uniform mediump float u_pixels_per_cycle;\n' +
  'const mediump float CANVAS_WIDTH=400.0;\n' +
  'void main() {\n' +
